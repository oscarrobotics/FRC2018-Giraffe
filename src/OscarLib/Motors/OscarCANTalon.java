...
public class OscarCANTalon implements IOscarSmartMotor {
    ...
    @Override
    public void follow(IOscarSmartMotor masterMotor) { follow(masterMotor.getDeviceID()); }
    ...
    @Override
    public int getDeviceID() { return _talon.getDeviceID(); }

    @Override
    public void setNeutralMode(NeutralMode mode) { _talon.setNeutralMode(mode); }

    @Override
    public void setSensorPhase(boolean phase) { _talon.setSensorPhase(phase); }

    @Override
    public void setSensor(FeedbackDevice device) { _talon.configSelectedFeedbackSensor(device, 0, 0); }

    @Override
    public void setAllowableClosedLoopError(int error) { _talon.configAllowableClosedloopError(0, error, 0); }
